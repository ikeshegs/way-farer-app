...
busRoute.post('/bus', _auth["default"].verifyToken, _bus["default"].createBusValidator, _busController["default"].createBus); // busRoute.get('/api/v1/bus', auth.verifyToken, busController.getBuses);
